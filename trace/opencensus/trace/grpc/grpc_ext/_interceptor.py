...
class _InterceptorChannel(grpc.Channel):
  ...
  def unary_unary(self,
    ...
    if isinstance(self._interceptor, grpc_ext.UnaryClientInterceptor):
  ...
  def unary_stream(self,
    ...
    base_callable = self._channel.unary_stream(method, request_serializer,
                                               response_deserializer)
    if isinstance(self._interceptor, grpc_ext.StreamClientInterceptor):
...
def intercept_channel(channel, *interceptors):
  ...
  for interceptor in interceptors:
    if not isinstance(interceptor, grpc_ext.UnaryClientInterceptor) and \
       not isinstance(interceptor, grpc_ext.StreamClientInterceptor):
      raise TypeError('interceptor must be either a '
                      'grpc_ext.UnaryClientInterceptor or a '
                      'grpc_ext.StreamClientInterceptor')
...
class _InterceptorRpcMethodHandler(grpc.RpcMethodHandler):
  ...
  @property
  def unary_unary(self):
    if not isinstance(self._interceptor, grpc_ext.UnaryServerInterceptor):
  ...
  @property
  def unary_stream(self):
    if not isinstance(self._interceptor, grpc_ext.StreamServerInterceptor):

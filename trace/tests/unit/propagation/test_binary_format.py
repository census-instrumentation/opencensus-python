...
class TestBinaryFormat(unittest.TestCase):
    ...
    def test_from_header_length_not_equal(self):
    ...
    def test_from_header_wrong_format(self):
        # Should raise struct.error because the binary is from wrong data type.
        # The test data is using UNSIGNED_CHAR to generate span_id binary data
        # which is wrong.
        binary_header = b'\x00\x00\xa0\xb7,\xa1\\\x1aK\xd1\x89b\xd0\xacY' \
                        b'\xdc\x90\xb9\x01{\x02\x01'

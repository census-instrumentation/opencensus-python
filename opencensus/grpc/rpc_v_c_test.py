...
class RPCVCTests(unittest.TestCase):
    ...
    def test_client_measures(self):
        self.assertEqual(
            self.rpc_view.grpc_client_sent_bytes_per_rpc_view.name,
            "grpc.io/client/sent_bytes_per_rpc",
            "grpc_client_sent_bytes_per_rpc_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_received_bytes_per_rpc_view.description,
            "Received bytes per RPC",
            "grpc_client_received_bytes_per_rpc_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_roundtrip_latency_view.measure.name,
            "grpc.io/client/roundtrip_latency",
            "grpc_client_roundtrip_latency_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_completed_rpc_view.measure.name,
            "grpc.io/client/roundtrip_latency",
            "grpc_client_completed_rpc_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_started_rpc_view.description,
            "Number of started client RPCs",
            "grpc_client_started_rpc_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_sent_messages_per_rpc_view.name,
        ...
        self.assertEqual(
            self.rpc_view.grpc_client_server_latency_view.measure.unit,
            "ms",
            "grpc_client_server_latency_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_sent_messages_per_method_view.name,
        ...
        self.assertEqual(
            self.rpc_view.grpc_client_sent_bytes_per_method_view.measure.unit,
            "by",
            "grpc_client_sent_bytes_per_method_view not set correctly")

        self.assertEqual(
            self.rpc_view.grpc_client_received_bytes_per_method_view.name,

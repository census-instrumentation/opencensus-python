...
_SPAN_TRACESTATEENTRY = _descriptor.Descriptor(
  name='TracestateEntry',
  full_name='opencensus.proto.trace.v1.Span.TracestateEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='opencensus.proto.trace.v1.Span.TracestateEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='opencensus.proto.trace.v1.Span.TracestateEntry.value', index=1,
...
_SPAN_TRACESTATEENTRY.containing_type = _SPAN
...
_SPAN.fields_by_name['tracestate'].message_type = _SPAN_TRACESTATEENTRY
...
Span = _reflection.GeneratedProtocolMessageType('Span', (_message.Message,), dict(
  ...
  TracestateEntry = _reflection.GeneratedProtocolMessageType('TracestateEntry', (_message.Message,), dict(
    DESCRIPTOR = _SPAN_TRACESTATEENTRY,
    __module__ = 'opencensus.proto.trace.v1.trace_pb2'
    # @@protoc_insertion_point(class_scope:opencensus.proto.trace.v1.Span.TracestateEntry)
    ))
  ,
...
_sym_db.RegisterMessage(Span.TracestateEntry)
...
_SPAN_TRACESTATEENTRY.has_options = True
_SPAN_TRACESTATEENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))

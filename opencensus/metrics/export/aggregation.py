...
from opencensus.metrics.export import bucket_boundaries
from opencensus.metrics.export import aggregation_data
...
class SumAggregation(BaseAggregation):
    ...
    :type aggregation_type: :class:`~opencensus.metrics.export.aggregation.Type`
    :param aggregation_type: represents the type of this aggregation
...
class DistributionAggregation(BaseAggregation):
    ...
    :type boundaries: list(:class:'~opencensus.metrics.export.bucket_boundaries.
                            BucketBoundaries')

...
"""
Utilities to convert view data models to metrics data models.
"""
...
def get_metric_type(measure, aggregation):
    """Get the corresponding metric type for the given aggregation type.

    :type measure: (:class: '~opencensus.metrics.export.measure.BaseMeasure')
    :param measure: the measure for which to find a metric type

    :type aggregation: (:class:
    '~opencensus.metrics.export.aggregation.BaseAggregation')

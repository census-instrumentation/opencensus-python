...
from opencensus.metrics.export.measurement_map import MeasurementMap
from opencensus.metrics.export.measure_to_view_map import MeasureToViewMap
from opencensus.metrics.export import execution_context


class MetricsRecorder(object):
    """Metrics Recorder provides methods to record metrics against tags
    ...
    def new_measurement_map(self):
        """Creates a new MeasurementMap in order to record metrics
